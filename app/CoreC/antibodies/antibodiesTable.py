...
class antibodiesTable(BaseDatabaseTable):
    ...
    def display(self, Uinputs: str, sort: str) -> dict:
        ...
        if len(Uinputs) != 0:
            ...
            data = search_utils.search_data_sorted(Uinputs, columns_to_check, 10, SqlData, {'Box_Name': 'Box Name', 'Company_name': 'Company', 'Catalog_Num': 'Catalog number', 'Target_Name': 'Target', 'Target_Species': 'Target Species', 'Clone_Name': 'Clone', 'Expiration_Date': 'Expiration Date', 'Cost': 'Cost ($)'})
