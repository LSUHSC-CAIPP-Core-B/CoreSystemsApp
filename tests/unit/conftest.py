...
def mock_db_config(tmp_path):
    ...
    coreb_config.write_text(
        '{"db_config": {"host": "localhost", "database": "test_coreb", "user": "test", "password": "test"}}'
    )

    corec_config = config_dir / "CoreC.json"
    corec_config.write_text(
        '{"db_config": {"host": "localhost", "database": "test_corec", "user": "test", "password": "test"}}'
    )
